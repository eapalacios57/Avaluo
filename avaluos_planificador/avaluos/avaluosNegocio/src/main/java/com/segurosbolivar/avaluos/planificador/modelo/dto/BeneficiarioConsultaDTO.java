 ...
 */
@XmlRootElement
public class BeneficiarioConsultaDTO implements Serializable{	
	...
	private String medioComunicacionValor;
	...
	public String getMedioComunicacionValor() {
		return medioComunicacionValor;
	}


	public void setMedioComunicacionValor(String medioComunicacionValor) {
		this.medioComunicacionValor = medioComunicacionValor;
	}


	public BeneficiarioConsultaDTO(){
    ...
    public boolean equals(Object obj) {
        ...
        final BeneficiarioConsultaDTO other = (BeneficiarioConsultaDTO) obj;
