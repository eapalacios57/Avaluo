...
import com.segurosbolivar.avaluos.modelo.service.util.SearchExpressionCriteria;
import com.segurosbolivar.avaluos.modelo.service.util.SearchExpressionOrder;
import com.segurosbolivar.avaluos.modelo.service.util.UtilConstantes;

public abstract class ManejadorCrudPlan<T, U> implements IManejadorCrudPlan<T, U>, Serializable {
	...
	private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger
			.getLogger(ManejadorCrudPlan.class.getName());

	public static final Integer IGNORAR_PARAMETRO_CONSULTA = -1;

	@EJB
	protected ManejadorPersistenciaPlan<T> mp;
	 ...
	 */
	public ManejadorCrudPlan(Class<T> claseEntidad) {
