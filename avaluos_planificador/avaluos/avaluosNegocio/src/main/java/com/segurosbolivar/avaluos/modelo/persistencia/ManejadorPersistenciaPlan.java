 ...
 */
@Stateless
public class ManejadorPersistenciaPlan<T> implements Serializable {
	...
	private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger
			.getLogger(ManejadorPersistenciaPlan.class.getName());
		...
		if (esPkCompleja(idObj)) {
			...
			for (String atributo : atributosId) {
				try {
					...
					Logger.getLogger(ManejadorPersistenciaPlan.class.getName()).log(Level.SEVERE, null, ex);
				}
			}
		} else {
